...
import styled, { css as css$1 } from 'vue-emotion';
import { darken, lighten, rgba } from 'polished';
import VueTypes from 'vue-types';
import configureStore, { helper, Actions, suggestions, causes } from '@appbaseio/reactivecore';
...
var Input = styled('input')(_templateObject5$2, input, function (_ref3) {
	...
	return (
		// for clear icon
		props.showClear && css(_templateObject7$2)
	);
}, function (props) {
	return (
		// for clear icon with search icon
		props.showClear && props.showIcon && props.iconPosition === 'right' && css(_templateObject8$2)
	);
}, function (props) {
	return props.alert && alertBorder;
});

var suggestions$1 = function suggestions$$1(themePreset, theme) {
	return css(_templateObject9$1, themePreset === 'dark' && dark$1(theme));
};

var suggestionsContainer = css(_templateObject10$1);
...
var debounce = helper.debounce,
    ...
    getClassName$2 = helper.getClassName;
...
var DataSearch = {
	...
	methods: {
		...
		onSuggestions: function onSuggestions(results) {
			...
			return suggestions(fields, results, this.$data.currentValue.toLowerCase());
		},
					...
					default: function _default(_ref) {
						...
						return h(
							...
							[h(Input, _mergeJSXProps([{
								...
								'ul',
								{
									'class': suggestions$1(_this4.themePreset, theme) + ' ' + getClassName$2(_this4.$props.innerClass, 'list')
								},
...
var getQueryOptions$1 = helper.getQueryOptions,
    ...
    getAggsOrder = helper.getAggsOrder,
...
var isEqual$2 = helper.isEqual,
    ...
    getAggsOrder$1 = helper.getAggsOrder,
...
var getAggsOrder$2 = helper.getAggsOrder;
				...
				default: function _default(_ref) {
					...
					return h(
						...
						[h(
							...
							'ul',
							{
								'class': suggestions$1(themePreset, _this.theme) + ' ' + (_this.$props.small ? 'small' : '') + ' ' + getClassName$5(_this.$props.innerClass, 'list')
							},
...
var getQueryOptions$3 = helper.getQueryOptions,
    ...
    getClassName$6 = helper.getClassName;
...
var setValue$2 = Actions.setValue,
    clearValues = Actions.clearValues;
var getClassName$8 = helper.getClassName;
...
var isEqual$6 = helper.isEqual,
    ...
    getClassName$a = helper.getClassName;
...
var getClassName$b = helper.getClassName;
...
var getClassName$c = helper.getClassName;
...
var checkValueChange$7 = helper.checkValueChange,
...
export { version, install, ReactiveList, ResultCard, ResultList, ReactiveBase, DataSearch, SingleList, MultiList, SingleRange, MultiRange, RangeSlider, ReactiveComponent, SelectedFilters, SingleDropdownList, MultiDropdownList };
